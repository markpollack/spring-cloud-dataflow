...
public class LocalServerSecurityWithUsersFileTestsWithoutTasks {
    ...
    private final static Logger logger = LoggerFactory.getLogger(LocalServerSecurityWithUsersFileTestsWithoutTasks
            .class);
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
			...
			/* AppRegistryController */
                ...
                {HttpMethod.POST, HttpStatus.FORBIDDEN, "/apps", adminOnlyUser, ImmutableMap.of("uri", "???", "apps",
                        "??", "force", "true")},
			...
			/* CompletionController */
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/completions/stream", adminOnlyUser, ImmutableMap.of
                        ("detailLevel", "2")},
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/completions/task", adminOnlyUser, ImmutableMap.of
                        ("detailLevel", "2")},
			...
			/* JobExecutionController */
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/jobs/executions", adminOnlyUser, ImmutableMap.of("page",
                        "0", "size", "10")},
                {HttpMethod.GET, HttpStatus.NOT_FOUND, "/jobs/executions", viewOnlyUser, ImmutableMap.of("page", "0",
                        "size", "10")},
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/jobs/executions", adminOnlyUser, ImmutableMap.of("name",
                        "myname")},
                ...
                {HttpMethod.PUT, HttpStatus.FORBIDDEN, "/jobs/executions/123", adminOnlyUser, ImmutableMap.of("stop",
                        "true")},
                ...
                {HttpMethod.PUT, HttpStatus.FORBIDDEN, "/jobs/executions/123", adminOnlyUser, ImmutableMap.of
                        ("restart", "true")},
			...
			/* JobInstanceController */
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/jobs/instances", adminOnlyUser, ImmutableMap.of("name",
                        "my-job-name")},
			...
			/* JobStepExecutionController */
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/jobs/executions/123/steps", adminOnlyUser, ImmutableMap.of
			...
			/* StreamDefinitionController */
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/streams/definitions", adminOnlyUser, ImmutableMap.of("page",
                        "0", "size", "10")},
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/streams/definitions", adminOnlyUser, ImmutableMap.of
                        ("search", "mysearch")},
                ...
                {HttpMethod.POST, HttpStatus.FORBIDDEN, "/streams/definitions", adminOnlyUser, ImmutableMap.of
			...
			/* TaskDefinitionController */
                ...
                {HttpMethod.POST, HttpStatus.FORBIDDEN, "/tasks/definitions", adminOnlyUser, ImmutableMap.of("name",
                        "my-name")},
                {HttpMethod.POST, HttpStatus.FORBIDDEN, "/tasks/definitions", viewOnlyUser, ImmutableMap.of("name",
                        "my-name")},
                {HttpMethod.POST, HttpStatus.NOT_FOUND, "/tasks/definitions", createOnlyUser, ImmutableMap.of("name",
                        "my-name")},
                ...
                {HttpMethod.POST, HttpStatus.FORBIDDEN, "/tasks/definitions", viewOnlyUser, ImmutableMap.of("name",
                        "my-name", "definition", "foo")},
                {HttpMethod.POST, HttpStatus.NOT_FOUND, "/tasks/definitions", createOnlyUser, ImmutableMap.of("name",
                        "my-name", "definition", "foo")}, //Should be a `400` error - See also: https://github
			...
			/* TaskExecutionController */
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/tasks/executions", adminOnlyUser, ImmutableMap.of("page",
                        "0", "size", "10")},
                {HttpMethod.GET, HttpStatus.NOT_FOUND, "/tasks/executions", viewOnlyUser, ImmutableMap.of("page",
                        "0", "size", "10")},
                ...
                {HttpMethod.GET, HttpStatus.FORBIDDEN, "/tasks/executions", adminOnlyUser, ImmutableMap.of("name",
                        "my-task-name")},
                ...
                {HttpMethod.POST, HttpStatus.FORBIDDEN, "/tasks/executions", adminOnlyUser, ImmutableMap.of("name",
                        "my-task-name")},
