...
2. Configure any one of the Data Flow Server implementations to delegate the deployment to new server in the Spring Cloud ecosystem named http://cloud.spring.io/spring-cloud-skipper/[Skipper].
...
[[spring-cloud-dataflow-deploy-stream-skiper]]
=== Deploying a Stream using Skipper
