...
public class TaskParser extends AppParser {
    ...
    /**
     * Controls usage mode for the parser. If true then apps can take arguments, if
     * false then app definitions are expected which take no arguments (currently).
     */
     ...
     * @param inAppMode      if true then expect apps with arguments otherwise expect app definition references
