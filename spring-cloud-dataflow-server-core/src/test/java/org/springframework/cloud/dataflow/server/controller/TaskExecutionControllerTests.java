...
public class TaskExecutionControllerTests {
	...
	public void setupMockMVC() {
		...
		if (!initialized) {
			...
			TaskExecution taskExecution = dao.createTaskExecution(TASK_NAME_FOOBAR, new Date(), new ArrayList<>(),
					null);
	...
	public void testGetExecution() throws Exception {
		mockMvc.perform(get("/tasks/executions/1").accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
