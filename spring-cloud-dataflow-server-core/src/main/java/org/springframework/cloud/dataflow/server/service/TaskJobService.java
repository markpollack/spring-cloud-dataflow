...
public interface TaskJobService {
     ...
     * to stop processing. This method does not guarantee a {@link JobExecution}
     * to stop. It is the responsibility of the implementor of the {@link Job} to
     * react to that request. Furthermore, this method does not interfere with the
     * associated {@link TaskExecution}.
     *
