...
public class RootController {
    ...
    public RootResource info() {
        ...
        if (featuresProperties.isStreamsEnabled()) {
            root.add(entityLinks.linkToCollectionResource(StreamDefinitionResource.class).withRel
                    ("streams/definitions"));
            root.add(unescapeTemplateVariables(entityLinks.linkToSingleResource(StreamDefinitionResource.class,
                    "{name}").withRel("streams/definitions/definition")));
            root.add(entityLinks.linkToCollectionResource(StreamDeploymentResource.class).withRel
                    ("streams/deployments"));
            root.add(unescapeTemplateVariables(entityLinks.linkToSingleResource(StreamDeploymentResource.class,
                    "{name}").withRel("streams/deployments/deployment")));
            root.add(entityLinks.linkToCollectionResource(AppStatusResource.class).withRel("runtime/apps"));
            root.add(unescapeTemplateVariables(entityLinks.linkForSingleResource(AppStatusResource.class, "{appId}")
                    .withRel("runtime/apps/app")));
            root.add(unescapeTemplateVariables(entityLinks.linkFor(AppInstanceStatusResource.class, UriComponents
                    .UriTemplateVariables.SKIP_VALUE).withRel("runtime/apps/instances")));
        ...
        if (featuresProperties.isTasksEnabled()) {
            ...
            root.add(unescapeTemplateVariables(entityLinks.linkToSingleResource(TaskDefinitionResource.class,
                    "{name}").withRel("tasks/definitions/definition")));
            ...
            root.add(unescapeTemplateVariables(entityLinks.linkFor(StepExecutionProgressInfoResource.class,
                    "{jobExecutionId}").slash("{stepId}").slash("progress").withRel
        ...
        if (featuresProperties.isAnalyticsEnabled()) {
            ...
            root.add(unescapeTemplateVariables(entityLinks.linkToSingleResource(CounterResource.class, "{name}")
                    .withRel("counters/counter")));
            root.add(entityLinks.linkToCollectionResource(FieldValueCounterResource.class).withRel
                    ("field-value-counters"));
            root.add(unescapeTemplateVariables(entityLinks.linkToSingleResource(FieldValueCounterResource.class,
                    "{name}").withRel("field-value-counters/counter")));
            root.add(
            ...
            root.add(unescapeTemplateVariables(entityLinks
                    .linkToSingleResource(AggregateCounterResource.class, "{name}").withRel
